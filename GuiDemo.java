...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		super("wise Sayings");  // Specifies the string for the title bar of the window.
		...
		drawPanel.getTextItem().setText(
				...
				"But bear in mind that just like Money,\n" +
				"the thirst for more power is the root for more evil .\n"+
				"                                                     (ezekiel victor)"
			);
		drawPanel.getTextItem().setFontSize(28);
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	    	...
    	    	ChooseBackgroundAction(String text) {
    	    		...
    	    		if (text.equals("Color...")) {
    	    			...
    	    			g.fillRect(0,0,15,36);
    	    			g.setColor(Color.magenta);
    	    			g.fillRect(12,0,12,30);
    				...
    				if (text.equals("Custom...")) {
    					...
    					if (inputFile != null) {
    						try {
    							...
    							JOptionPane.showMessageDialog(drawPanel, "Sorry,was not able to read file.");
    						}
    					}
    				}
